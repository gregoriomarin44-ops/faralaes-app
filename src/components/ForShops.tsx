    ...
    <div className="container">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-7 py-4 rounded-full bg-primary text-primary-foreground font-medium hover:bg-primary-deep transition-smooth shadow-coral"
        >
